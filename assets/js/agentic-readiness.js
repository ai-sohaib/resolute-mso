(() => {
  ...
  const tools = [
    ...
    },
    {
      ...
      description: "Return Resolute MSO business contact options. This tool never transmits form data and must not be used for PHI.",
  ...
  for (const tool of tools) {
    try {
      ...
      // Experimental implementations may reject unsupported fields.
    }
  }
})();
